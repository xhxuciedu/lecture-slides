...
% Section title slide
\begin{frame}
\frametitle{Performance Measures for Classification and Regression Models}
\begin{center}
...
\begin{frame}{ROC Curve and AUC}
  \begin{itemize}
    ...
    \item AUC summarizes ranking quality; $0.5$ is random.
  \end{itemize}
  \vspace{-0.2em}
  \begin{tikzpicture}
    \begin{axis}[
...
\begin{frame}{Threshold Selection}
  \begin{itemize}
    \item Decision threshold converts scores to labels.
    \item Choose operating point to match costs: $C_{FP}$ vs $C_{FN}$.
    \item Use validation data, ROC/PR curves, and cost-sensitive analysis.
  \end{itemize}
\end{frame}
