...
\title{Machine Learning Final Exam: 50 Multiple-Choice Questions}
\date{}
\author{}
...
\item For $L(w)=\max(0,1-yw^Tx)$, which is a valid subgradient when $yw^Tx < 1$?
...
\item Which line defines a convolution mapping 3 input channels to 8 output channels with kernel size 3 and padding 1?
